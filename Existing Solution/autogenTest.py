...
groupchat = autogen.GroupChat(agents=[patient, generalDoctor, nurse, radiologist, surgeon, gastroenterologist], messages=[], max_round=10)
...
with open("autogen-responses.json", "w") as f:
