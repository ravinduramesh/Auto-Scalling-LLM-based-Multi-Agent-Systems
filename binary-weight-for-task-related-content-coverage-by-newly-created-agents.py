...
plt.title("Task Related Content Coverage by Newly Created Agents")
plt.tight_layout()
...
conclusions.append("Test whether DRTAG's Binary Weighting scores are better than Autogen's Binary Weighting scores")
...
if p < standardSignificanceLevel:
    conclusions.append("Conclusion: We reject the null hypothesis. There is statistically significant evidence to conclude that discussions generated by newly created agents in DRTAG contains more keywords relavant to the scenario than discussions generated by newly created agents in Autogen.")
else:
    conclusions.append("Conclusion: We fail to reject the null hypothesis. There is no statistically significant evidence to conclude that discussions generated by newly created agents in DRTAG contains more keywords relavant to the scenario than discussions generated by newly created agents in Autogen.")
conclusions.append("")
...
conclusions.append("Test whether IAAG's Binary Weighting scores are better than Autogen's Binary Weighting scores")
conclusions.append(f"Mann-Whitney U Test: H={stat:.3f}, p={p:.4f}")
conclusions.append(f"Cliff's Delta: {delta_value:.3f} ({delta_magnitude})")
if p < standardSignificanceLevel:
    conclusions.append("Conclusion: We reject the null hypothesis. There is statistically significant evidence to conclude that discussions generated by newly created agents in IAAG contains more keywords relavant to the scenario than discussions generated by newly created agents in Autogen.")
else:
    conclusions.append("Conclusion: We fail to reject the null hypothesis. There is no statistically significant evidence to conclude that discussions generated by newly created agents in IAAG contains more keywords relavant to the scenario than discussions generated by newly created agents in Autogen.")
conclusions.append("")
...
conclusions.append("Test whether DRTAG's Binary Weighting scores are better than IAAG's Binary Weighting scores")
conclusions.append(f"Mann-Whitney U Test: H={stat:.3f}, p={p:.4f}")
conclusions.append(f"Cliff's Delta: {delta_value:.3f} ({delta_magnitude})")
if p < standardSignificanceLevel:
    conclusions.append("Conclusion: We reject the null hypothesis. There is statistically significant evidence to conclude that discussions generated by newly created agents in DRTAG contains more keywords relavant to the scenario than discussions generated by newly created agents in IAAG.")
else:
    conclusions.append("Conclusion: We fail to reject the null hypothesis. There is no statistically significant evidence to conclude that discussions generated by newly created agents in DRTAG contains more keywords relavant to the scenario than discussions generated by newly created agents in IAAG.")
conclusions.append("")
