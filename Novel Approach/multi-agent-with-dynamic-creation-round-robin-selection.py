...
def askGodBotToFindNextAgent(currentAgent):
    if currentAgent == "":
...
try:
    ...
    while askGodBotToConcludeConversation() == "No":
        ...
        nextAgentName = askGodBotToFindNextAgent(nextAgentName)
        sendMsgForAgent(nextAgentName)
except Exception as e:
    print(e)
finally:
    with open("messages-dynamic-agent-creation-round-robin-selection.json", "w") as f:
